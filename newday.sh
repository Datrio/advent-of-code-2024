...
curl --cookie "session=${SESSION_VALUE}" "https://adventofcode.com/2024/day/${DAY}/input" -o "${DAY}/input.txt"

PAGE_CONTENT=$(curl --cookie "session=${SESSION_VALUE}" "https://adventofcode.com/2024/day/${DAY}")
